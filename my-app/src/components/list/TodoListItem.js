  ...
  >
    <ListItem onPress={onPressTodo}>
      <TextContainer>
        ...
        >
          <TextContainer.text done={todo.done}>{todo.text}</TextContainer.text>
          <BtnContainer>
            <TouchableOpacity onPress={editTodo}>
              <ButtonIcon
                source={
                  todo.edit
                    ? require("../../assets/images/editPurple.png")
                    : todo.done
            ...
            <TouchableOpacity onPress={deleteTodo}>
              <ButtonIcon
                source={
                  todo.edit
                    ? require("../../assets/images/DeletPurple.png")
                    : todo.done
                    ? require("../../assets/images/DeletBlue.png")
                    : require("../../assets/images/Delet.png")
                }
              />
            </TouchableOpacity>
          </BtnContainer>
